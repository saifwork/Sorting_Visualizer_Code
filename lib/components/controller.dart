...
class _ControllerState extends State<Controller> {
  double _currentExecutionSpeedSliderValue =
      (MAX_EXEC_DELAY - DEFAULT_EXEC_DELAY + MIN_EXEC_DELAY).toDouble();
  double _currentBarNumberSliderValue = DEFAULT_BARS.toDouble();
        ...
        child: Column(
          ...
          children: [
              ...
              onValueChanged: (newIndex) {
                this.setState(
                  () {
                    ...
                    context.read<AlgorithmCubit>().changeAlgorithmType(
            ...
            ValueSlider(
              ...
              value: _currentBarNumberSliderValue,
