...
import '../algorithm_repository/algorithms/bubble_sort.dart';
import '../algorithm_repository/algorithms/heap_sort.dart';
import '../algorithm_repository/algorithms/insertion_sort.dart';
import '../algorithm_repository/algorithms/merge_sort.dart';
import '../algorithm_repository/algorithms/quick_sort.dart';
import '../algorithm_repository/algorithms/selection_sort.dart';
import '../algorithm_repository/base_algorithm.dart';
...
class AlgorithmCubit extends Cubit<AlgorithmState> {
  ...
  void changeExecutionSpeed({required Duration executionSpeed}) {
    emit(state.copyWith(executionDelay: executionSpeed));
  }

  void changeAlgorithmType({required AlgorithmType newAlgorithmType}) {
    this.reset(
